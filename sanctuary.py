...
FIXED_CHANNEL_NAME = "sanct-the-real-triad"
        ...
        while True:
            ...
            if target:
                while True:
                    ...
                    print(f"{RED}[1] !nuke     {WHITE}- Raid completa (ban + delete + spam) ")
                    print(f"{RED}[2] !die      {WHITE}- Deleta todos os canais do servidor")
                    print(f"{RED}[3] !chn      {WHITE}- Cria 50 canais com o nome fixo")
                    print(f"{RED}[4] !banall   {WHITE}- Bane todos os membros")
                    print(f"{RED}[5] !kick     {WHITE}- Expulsa todos os membros")
                    print(f"{RED}[6] !everyone {WHITE}- Spam infinito com menção @everyone")
                    print(f"{RED}[7] !spam     {WHITE}- Spam infinito da sua mensagem custom")
                    print(f"{RED}[8] !rename   {WHITE}- Muda o nome do servidor para sua mensagem")
                    print(f"{RED}[9] !webhook  {WHITE}- Cria webhooks e envia spam neles")
                    print(f"{RED}[10] !roleall {WHITE}- Cria 50 cargos com o nome fixo")
                    print(f"{RED}[11] !nick    {WHITE}- Muda o apelido de todos para o nome fixo")
                    print(f"{RED}[12] !dmall   {WHITE}- Tenta enviar sua mensagem no PV de todos")
                    print(f"{RED}[13] !purge   {WHITE}- Limpa as últimas mensagens dos canais")
